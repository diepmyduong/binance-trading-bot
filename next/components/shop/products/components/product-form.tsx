...
import { ProductLabelService } from "../../../../lib/repo/product-label.repo";
...
export function ProductForm({ product, category, ...props }: PropsType) {
  ...
  return (
    ...
    >
      ...
      <Field name="basePrice" label="Giá sản phẩm" cols={product ? 6 : 12} required>
          ...
          {/* <div className="col-span-12 mb-6">
            <div className="flex-flex-wrap gap-3">
              ...
              <Form
                ...
                onSubmit={(data) => {}}
              >
                <Field name="color" label="Chọn nhãn">
                  <Select
                    optionsPromise={() =>
                ...
                <Form.Footer>
                  <Form.ButtonGroup submitText={`${openLabel ? "Chỉnh sửa" : "Thêm"} nhãn`} />
                </Form.Footer>
              </Form>
            </div>
          </div> */}
